<template>
    <div class="container">
      ...
      <q-card class="report-card">
        ...
        <q-card-actions align="around">
          ...
          <q-btn @click="goToCrearOfertas" label="Crear Ofertas" color="primary" class="create-btn"></q-btn>
        </q-card-actions>
      </q-card>
    </div>
  </template>
  ...
  export default {
    data() {
      return {
        ...
        columns: [
          ...
          { name: 'descuento', required: true, label: 'Descuento', align: 'left', field: 'descuento', sortable: true },
          { name: 'fechaIni', required: true, label: 'Fecha de inicio', align: 'left', field: 'fechaIni', sortable: true },
          { name: 'fechaFin', required: true, label: 'Fecha de fin', align: 'left', field: 'fechaFin', sortable: true },
    ...
    methods: {
      fetchOfertas() {
        axios.get('http://localhost:5023/api/v1/Ofertas')
          .then(response => {
